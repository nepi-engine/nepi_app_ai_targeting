...
class AppAiTargetingControls extends Component {
  constructor(props) {
    super(props)
  ...
  getAppNamespace(){
    ...
    var namespace = this.state.appNamespace
    const propsNamespace = this.props.appNamespace
    if (propsNamespace){
      if (propsNamespace.indexOf('null') === -1 && propsNamespace !== namespace){
        this.setState({appNamespace: propsNamespace})
...
export default AppAiTargetingControls
